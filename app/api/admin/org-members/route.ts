...
export async function GET() {
  try {
    ...
    console.error("GET_ADMIN_ORG_MEMBERS_ERROR", error);
  ...
  try {
    ...
    const member = await prisma.orgMember.create({
      data: {
        ...
        image: await saveOrgMemberImage(imageValue),
        featured,
    ...
    console.error("CREATE_ORG_MEMBER_ERROR", error);
